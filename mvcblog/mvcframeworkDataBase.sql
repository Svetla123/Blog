...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2407277416ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mvcframework&table=posts">`mvcframework`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mvcframework&table=users">`mvcframework`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mvcframework&table=user">`mvcframework`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5c5d346e7c61455b3b394e404a316b32">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="mvcframework" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `users` (`id`, `username`, `email`, `password`) VALUES (&#039;2&#039;, &#039;user&#039;, &#039;user@gmail.com&#039;, &#039;user&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mvcframework" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users` WHERE id =2;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mvcframework" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="mvcframework" targettable="posts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">EXPLAIN SELECT * FROM `posts`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mvcframework" targettable="posts">
                            <div class="action_content">
